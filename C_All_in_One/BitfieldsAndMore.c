...
struct Flags
{
    unsigned char flag_01;  // hier soll nur eine 1 oder 0 stehen // wegen meiner Anwendung
...
{
    unsigned char flag_01 : 1; // hier soll - und kann - nur eine 1 oder 0 stehen // wegen meiner Anwendung
...
{
    char   member1;  // 1 Byte
    short  member2;  // 2 Byte
    float  member3;  // 4 Byte
    double member4;  // 8 Byte
};

union SecondUnionExample   // RGB
{
...
{
    RGB red = { .color = 0x0012CDF0 };  // designated initializer syntax
...
// typedef int   short;
// a) scheint nicht zu gehen
// b) DON'T DO THIS

// ES GINGE .. UND DAS WÄRE ABSOLUT OKAY:
